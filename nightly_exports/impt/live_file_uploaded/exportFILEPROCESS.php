...
//SHIBBOLETH LOG-IN IS CAUSING THE SCRAPER TO NOT PULL DATA.
//IF I READ THIS LOCATION, I JUST GET A BLANK PAGE.

//$myURL = "https://housing.ncsu.edu/reports/occu_dash/nightly_exports/reports_to_read_data/nightly_export_current_term.php";

//testing 12-03-2015 @ 4:12pm.
//try pulling up something that is not protected, but is on the housing domain.
//has a table within the webpage.
$myURL = "https://housing.ncsu.edu/costs";
...
//Create a year folder
                ...
                //Create Directory
                //Year
				//This causes a YEAR directory to be inside the /reports/occu_dash/nightly_exports/impt/ folder...
				//not what we want.
				
				//We want all exports to be within /reports/occu_dash/nightly_exports/exports/[HERE]
